...
class CampaignsAjax extends Controller {
    ...
    private function is_enabled_toggle() {
        ...
        db()->where('campaign_id', $_POST['campaign_id'])->where('user_id', $this->user->id)->update('campaigns', [
    ...
    private function create() {
        ...
        $account_total_campaigns = database()->query("SELECT COUNT(*) AS `total` FROM `campaigns` WHERE `user_id` = {$this->user->id}")->fetch_object()->total;
