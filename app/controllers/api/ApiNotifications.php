...
class ApiNotifications extends Controller {
    ...
    private function get_all() {
        ...
        $total_rows = database()->query("SELECT COUNT(*) AS `total` FROM `notifications` WHERE `user_id` = {$this->api_user->id}")->fetch_object()->total ?? 0;
    ...
    private function get() {
        ...
        $notification = db()->where('notification_id', $notification_id)->where('user_id', $this->api_user->id)->getOne('notifications');
