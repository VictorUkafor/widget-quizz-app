    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                /* Database query */
                db()->where('user_id', $this->user->id)->update('users', [
                    'name' => $_POST['name'],
                ...
                if($_POST['email'] != $this->user->email) {
                    ...
                    if(settings()->users->email_confirmation) {
                        ...
                        db()->where('user_id', $this->user->id)->update('users', ['email' => $_POST['email']]);
                ...
                if(!empty($_POST['old_password']) && !empty($_POST['new_password'])) {
                    ...
                    db()->where('user_id', $this->user->id)->update('users', ['password' => $new_password]);
