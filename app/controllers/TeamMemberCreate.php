            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                $email_template = get_email_template(
                    ...
                    [
                        ...
                        '{{LOGIN_LINK}}' => url('login?redirect=teams&email=' . $_POST['user_email']),
                        '{{REGISTER_LINK}}' => url('register?redirect=teams&email=' . $_POST['user_email']) . '&unique_registration_identifier=' . md5($_POST['user_email'] . $_POST['user_email']),
                    ],
