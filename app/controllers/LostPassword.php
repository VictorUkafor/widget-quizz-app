    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                $user = db()->where('email', $_POST['email'])->getOne('users', ['id', 'email', 'name', 'status', 'language']);
                ...
                if($user && $user->status != 2) {
                    ...
                    db()->where('id', $user->id)->update('users', ['lost_password_code' => $lost_password_code]);
                    ...
                    Logger::users($user->id, 'lost_password.request_sent');
                }
