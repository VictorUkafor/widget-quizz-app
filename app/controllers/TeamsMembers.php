...
class TeamsMembers extends Controller {
    ...
    public function delete() {
        ...
        elseif($team_member->user_id == $this->user->id || $team_member->user_email == $this->user->email) {
    ...
    public function login() {
        ...
        if(!$team_member = db()->where('team_member_id', $team_member_id)->where('user_id', $this->user->id)->where('status', 1)->getOne('teams_members')) {
            dd('teams-member');
        }
