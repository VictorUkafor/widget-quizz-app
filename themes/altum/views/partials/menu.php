...
<nav class="navbar navbar-main <?= \Altum\Routing\Router::$controller_settings['menu_no_margin'] ? null : 'mb-6'?> navbar-expand-lg navbar-light bg-white">
    <div class="container">
                ...
                <?php if(\Altum\Middlewares\Authentication::check()): ?>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?= url('campaigns') ?>"><i class="fa fa-fw fa-sm fa-server mr-2"></i> <?= l('campaigns.menu') ?></a>
                            <div class="dropdown-divider"></div>
