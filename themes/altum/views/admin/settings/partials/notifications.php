...
<div>
    ...
    <div class="form-group">
        <label for="analytics_is_enabled"><?= l('admin_settings.notifications.analytics_is_enabled') ?></label>
        <select id="analytics_is_enabled" name="analytics_is_enabled" class="form-control form-control-lg">
            <option value="1" <?= settings()->notifications->analytics_is_enabled ? 'selected="selected"' : null ?>><?= l('global.yes') ?></option>
            <option value="0" <?= !settings()->notifications->analytics_is_enabled ? 'selected="selected"' : null ?>><?= l('global.no') ?></option>
        </select>
